...
while (buceoRepetitivo) {
    ...
    otroBuceoValido = true;
    while (otroBuceoValido) {
        otroBuceo = prompt("Quiere registrar Otro Buceo");
        if (otroBuceo == "SI" || otroBuceo == "Si" || otroBuceo == "si") {
            otroBuceoValido = false;
            buceoRepetitivo = true;
            profundidadNoValida = true;
            tiempoNoValido = true;
            buceoCont = buceoCont + 1;
        } else if (otroBuceo == "NO" || otroBuceo == "No" | otroBuceo == "no") {
            otroBuceoValido = false;
            buceoRepetitivo = false;
        } else {
            otroBuceoValido = true;
        }
    }
